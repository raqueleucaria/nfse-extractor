...
from extractor.data_extractor import extract_nfse_data, ExtractorError
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Exemplo: python extract_cli.py 'test_files/NFSe_ficticia_layout_completo.pdf'"
    )
    parser.add_argument(
        "filepath",
        type=str,
        help="Caminho completo para o arquivo PDF ou de imagem a ser processado."
    )
